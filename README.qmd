...
Slides and notes for a workshop at R/Medicine 2024 (10th June 2024) online.
...
* Time series exploratory data analysis
  * Time series data (tsibble, key, index)
  * Time series patterns (trend, seasonality, cycles)
  * Time series visualisation (time, seasonal, subseries, ACF plots)
* Modelling and forecasting
  * Simple models (Naive, Seasonal naive, RW w/ drift)
  * ETS (additive and multiplicative patterns)
  * Transformations
  * ARIMA (autocorrelations)
* Accuracy evaluation
  * Accuracy measures
